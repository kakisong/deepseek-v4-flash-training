...
def _main() -> int:
    ...
    requirements = [
        ...
        },
        {
            ...
            "claim": "TE grouped MLP and EP=8 all-to-all dispatcher math pass forward/backward/update checks.",
            "evidence": [
                "deepseek-v4-grouped-mlp-math-20260531.json",
                "deepseek-v4-moe-ep8-dispatch-math-20260531.json",
            ],
            "summary_gates": ["grouped_mlp_training_math", "moe_ep8_alltoall_dispatch_math"],
            "doc_sections": ["算子数学验证"],
            "status": "PROVED",
        },
        {
        ...
        },
        {
            ...
            "claim": "One-layer DeepSeek-V4 training blocks pass explicit PyTorch external-reference forward/backward/update parity for non-compressed attention, compress_ratio=4 indexer, deterministic compress_ratio=128 compressed attention, and score-routed MoE.",
            "evidence": [
            ...
            "summary_gates": ["external_training_reference_1layer", "external_training_reference_1layer_moe"],
