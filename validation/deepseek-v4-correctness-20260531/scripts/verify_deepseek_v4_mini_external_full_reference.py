...
try:
    from tools.verify_deepseek_v4_external_training_reference import (
        SEED,
    ...
    from tools.verify_deepseek_v4_mini_train_step_parity import (
        _is_selected_param,
        _manual_update_param,
        _prepare_manual_grad_buffers,
        _zero_manual_grad_buffers,
    )
    from tools.verify_deepseek_v4_sft_loss_reference import (
        _all_reduce_float,
        _all_reduce_int,
